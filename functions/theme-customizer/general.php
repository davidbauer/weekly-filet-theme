...
function wpex_customizer_general($wp_customize) {
	...
	// Blog readmore
	$wp_customize->add_setting( 'wpex_blog_entry_share', array(
		'type'		=> 'theme_mod',
		'default'	=> '1',
	) );
	$wp_customize->add_control( 'wpex_blog_entry_share', array(
		'label'		=> __('Entry Share Button','wpex'),
		'section'	=> 'wpex_general',
		'settings'	=> 'wpex_blog_entry_share',
		'type'		=> 'checkbox',
		'priority'	=> '5',
	) );
	...
	$wp_customize->add_control( 'wpex_post_meta', array(
		'label'		=> __('Single Post Meta','wpex'),
		'section'	=> 'wpex_general',
	...
	$wp_customize->add_control( 'wpex_entry_content_excerpt', array(
		'label'		=> __( 'Entry Display','wpex'),
		'section'	=> 'wpex_general',
		'settings'	=> 'wpex_entry_content_excerpt',
		'priority'	=> '15',
		'type'		=> 'select',
		'choices'	=> array (
			'excerpt'	=> __( 'Excerpt', 'wpex' ),
	...
	$wp_customize->add_control( 'wpex_excerpt_length', array(
		'label'		=> __( 'Entry Excerpt Length','wpex'),
		'section'	=> 'wpex_general',
