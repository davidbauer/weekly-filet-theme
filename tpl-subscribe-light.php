...
<div>To get more like this, subscribe to the The Weekly Filet. <span class="highlight">5 recommended links, every Friday, free home-delivery.</span> Brought to you by journalist David Bauer. <a href="/about">Learn more</a>.</div>
...
<div class="mc-field-group" style="margin: 0.5em 0;float:left;width:95%;clear: both;overflow: hidden;">
<input type="text" value="" placeholder="email address" name="EMAIL" class="required email" id="mce-EMAIL" style="font-size:20px;margin-right: 1.5em;padding: .2em .3em;width: 90%;float: left;z-index: 999;overflow:hidden;">
<input type="submit" value="Subscribe now" name="subscribe" id="mc-embedded-subscribe" class="btn" style="clear: both;font-size:21px; display:block;margin: 0.3em auto 0.1em;width:250px;float:left;">
</div>
...
<!--End mc_embed_signup-->
<p>Other ways to follow: <a href="http://www.weeklyfilet.com/feed" target="_blank">RSS</a>, <a href="http://flip.it/eY4hS" target="_blank">Flipboard</a>.</p>
</div>